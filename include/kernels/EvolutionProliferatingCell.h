 ...
 * $\nabla u \cdot \nabla \phi_i$
 */
class EvolutionProliferatingCell : public Kernel
{
public:
  static InputParameters validParams(); //funzione che legge parametri del Kernel

  EvolutionProliferatingCell(const InputParameters & parameters); // costruttore della classe
