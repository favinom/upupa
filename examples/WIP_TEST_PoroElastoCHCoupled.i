...
[./additionalfluxp] type = ChemicalFluxDivergence variable = p m = 0.001 solid_fraction = 0.5 sign_chemkernel = -1 disp_x = disp_x disp_y = disp_y J_K = J_K mu_K = mu_K [../]

[./massbalancediffusion] type = ChemicalFluxDivergence variable = mu_K m = 0.001 disp_x = disp_x disp_y = disp_y J_K = J_K mu_K = mu_K [../]
[./offdiagonaltimederivative] type = OffDiagonalTimeDerivative variable = mu_K J_K = J_K [../]

[./potential] type = ChemicalPotential variable = J_K alpha = 0.1 disp_x = disp_x disp_y = disp_y J_K = J_K mu_K = mu_K save_in = residuo_jk [../]
[./coupling] type = CouplingGrowthMechanics variable = J_K disp_x = disp_x disp_y = disp_y p = p J_K = J_K save_in = residuo_jk [../]
[]

[ICs]
#[./J_K_IC] type = FunctionIC  variable = 'J_K'  function = 1  [../]
#[./J_K_IC] type = FunctionIC  variable = 'J_K'  function = 1+0.3*(x<0.299)*(y<0.299)  [../]
...
#[./topJK] type = CouplingGrowthBC variable = J_K boundary = top disp_x = disp_x disp_y = disp_y J_K = J_K save_in = residuo_jk [../]
#[./rightJK] type = CouplingGrowthBC variable = J_K boundary = right disp_x = disp_x disp_y = disp_y J_K = J_K save_in = residuo_jk [../]
#[./bottomJK] type = CouplingGrowthBC variable = J_K boundary = bottom disp_x = disp_x disp_y = disp_y J_K = J_K save_in = residuo_jk [../]
#[./leftJK] type = CouplingGrowthBC variable = J_K boundary = left disp_x = disp_x disp_y = disp_y J_K = J_K save_in = residuo_jk [../]
