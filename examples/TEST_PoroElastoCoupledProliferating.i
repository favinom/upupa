...
[.proliferating] type = EvolutionProliferatingCell variable = cp m = 0.1 disp_x = disp_x disp_y = disp_y J_K = J_K mu_K = mu_K cp = cp [../]
[]
...
[./cp_IC] type = FunctionIC  variable = 'cp'  function = 0.3  [../]
[]
