...
[./additionalfluxp] type = ChemicalFluxDivergence variable = p m = 0.1 solid_fraction = 0.5 sign_chemkernel = -1 disp_x = disp_x disp_y = disp_y J_K = J_K mu_K = mu_K [../]

[./massbalancediffusion] type = ChemicalFluxDivergence variable = mu_K m = 0.1 disp_x = disp_x disp_y = disp_y J_K = J_K mu_K = mu_K [../]
[./offdiagonaltimederivative] type = OffDiagonalTimeDerivative variable = mu_K J_K = J_K [../]

[./potential] type = ChemicalPotential variable = J_K alpha = 0.1 J_K = J_K mu_K = mu_K [../]
[]

[ICs]
#[./J_K_IC] type = FunctionIC  variable = 'J_K'  function = 1  [../]
[./J_K_IC] type = FunctionIC  variable = 'J_K'  function = 1+0.3*(x<0.299)*(y<0.299)  [../]
#[./mu_K_IC] type = FunctionIC  variable = 'mu_K'  function = 1  [../]
[]

[BCs]
[./topx] type = NeumannBC variable = disp_x value = 0.0 boundary = top  [../]
[./topy] type = FunctionNeumannBC variable = disp_y function = -0.1*t*(t<1.5) boundary = top  [../]
