...
[.nutrients] type = EvolutionNutrient variable = omega permeability = 0.001 diffusivity = 0.5 disp_x = disp_x disp_y = disp_y p = p J_K = J_K omega = omega [../]
[]
...
[./omega_IC] type = FunctionIC  variable = 'omega'  function = 0.3+0.3*x-0*25*x^2*(1-x)^2*y^2*(1-y)^2 [../]
[]
